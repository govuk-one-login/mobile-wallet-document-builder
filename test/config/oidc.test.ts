...
process.env.OIDC_PRIVATE_KEY = "";
...
describe("oidc.ts", () => {
    it("should return the OIDC configuration", () => {
        ...
        expect(response).toEqual({"clientId": "test-client-id", "discoveryEndpoint": "http://localhost:8000", "privateKey":  "", "redirectUri": "http://localhost:3000/return-from-auth"})
    })
