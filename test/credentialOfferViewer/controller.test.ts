import {
  CredentialOfferViewerConfig,
  credentialOfferViewerController,
} from "../../src/credentialOfferViewer/controller";
...
const config: CredentialOfferViewerConfig = {
  walletAppsConfig: walletAppsConfig,
  walletApps: ["test-app-1", "test-app-3"],
  environment: "test",
};

describe("credentialOfferViewerControllers", () => {
  afterEach(() => {
    jest.clearAllMocks();
  });
