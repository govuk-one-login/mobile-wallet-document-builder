...
aws --endpoint-url=http://localhost:4566 kms create-key \
    ...
    --tags '[{"TagKey":"_custom_id_","TagValue":"aa275b92-0def-4dfc-b0f6-87c96b26c6c7"}]'

aws --endpoint-url=http://localhost:4566 kms create-alias \
    --region eu-west-2 \
    --alias-name alias/localWalletKeyAlias \
    --target-key-id aa275b92-0def-4dfc-b0f6-87c96b26c6c7
